...
<head>
    ...
    <title>Forgot Password | HRMS Enterprise</title>
    <!-- Google Fonts: Outfit -->
...
<body class="bg-slate-950 text-slate-100 min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="w-full max-w-md p-6 z-10">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-400 mt-2 text-sm">Reset your security credentials</p>
        </div>

        <!-- Glassmorphism Card -->
        <div class="backdrop-blur-md bg-white/5 border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
            
            <h2 class="text-xl font-semibold mb-3 text-center text-slate-200">Forgot Password</h2>
            <p class="text-xs text-slate-400 text-center mb-6 leading-relaxed">
                Enter your email address and we will generate a 6-digit OTP code to verify your identity.
            </p>
            ...
            <form action="/forgot-password" method="POST" class="space-y-6" id="forgotPasswordForm">
                @csrf
