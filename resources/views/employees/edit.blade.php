...
<div class="space-y-6 max-w-5xl mx-auto">
    ...
    <div class="flex justify-between items-center bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-md">
        <div>
            <h2 class="text-xl font-bold text-white">Edit: {{ $employee->name }}</h2>
            <p class="text-slate-400 text-sm mt-1">Modify account settings, work role details, and financial parameters.</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="role" id="role" required
                            class="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-2.5 text-sm text-slate-100 focus:outline-none focus:border-indigo-500 transition">
                        @php $currentRole = $employee->roles->first()?->name; @endphp
        ...
        <div class="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-md space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="employee_code" id="employee_code" value="{{ old('employee_code', $employee->employeeDetail?->employee_code) }}" required
                ...
                <div>
                    ...
                    <input type="date" name="joining_date" id="joining_date" value="{{ old('joining_date', $employee->employeeDetail?->joining_date?->format('Y-m-d')) }}" required
                ...
                <div>
                    ...
                    <input type="date" name="exit_date" id="exit_date" value="{{ old('exit_date', $employee->employeeDetail?->exit_date?->format('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <select name="manager_id" id="manager_id"
                        ...
                        @foreach($managers as $mng)
                            <option value="{{ $mng->id }}" {{ old('manager_id', $employee->employeeDetail?->manager_id) == $mng->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="location_id" id="location_id" required
                        ...
                        @foreach($locations as $loc)
                            <option value="{{ $loc->id }}" {{ old('location_id', $employee->employeeDetail?->location_id) == $loc->id ? 'selected' : '' }}>
                                {{ $loc->location_name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="department_id" id="department_id" required
                        ...
                        @foreach($departments as $dept)
                            <option value="{{ $dept->id }}" {{ old('department_id', $employee->employeeDetail?->department_id) == $dept->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="designation_id" id="designation_id" required
                        ...
                        @foreach($designations as $desg)
                            <option value="{{ $desg->id }}" {{ old('designation_id', $employee->employeeDetail?->designation_id) == $desg->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="shift_id" id="shift_id" required
                        ...
                        @foreach($shifts as $shf)
                            <option value="{{ $shf->id }}" {{ old('shift_id', $employee->employeeDetail?->shift_id) == $shf->id ? 'selected' : '' }}>
        ...
        <div class="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-md space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="date" name="dob" id="dob" value="{{ old('dob', $employee->employeeDetail?->dob?->format('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <input type="text" name="pan_no" id="pan_no" value="{{ old('pan_no', $employee->employeeDetail?->pan_no) }}" placeholder="PAN Number"
                ...
                <div>
                    ...
                    <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $employee->employeeDetail?->bank_name) }}" placeholder="e.g. Chase, HSBC"
                ...
                <div>
                    ...
                    <input type="text" name="bank_account_no" id="bank_account_no" value="{{ old('bank_account_no', $employee->employeeDetail?->bank_account_no) }}" placeholder="Account Number"
