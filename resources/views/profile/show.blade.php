            ...
            <div id="tab-profile" class="tab-content bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-md space-y-6">
                ...
                <form action="{{ route('profile.update') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="tel" name="phone" value="{{ old('phone', $employee->employeeDetail?->phone) }}" oninput="this.value = this.value.replace(/[^0-9+\-\s()]/g, '');" class="w-full bg-slate-900 border border-white/10 rounded-xl px-3.5 py-2.5 text-slate-200 text-xs focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <form action="/change-password" method="POST" class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="password" name="current_password" id="current_password" required class="w-full bg-slate-900 border border-white/10 rounded-xl px-3.5 pr-10 py-2.5 text-slate-200 text-xs focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="password" name="new_password" id="new_password" required class="w-full bg-slate-900 border border-white/10 rounded-xl px-3.5 pr-10 py-2.5 text-slate-200 text-xs focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="password" name="new_password_confirmation" id="new_password_confirmation" required class="w-full bg-slate-900 border border-white/10 rounded-xl px-3.5 pr-10 py-2.5 text-slate-200 text-xs focus:ring-2 focus:ring-indigo-500 focus:outline-none">
        ...
        >
            ...
            <form :action="editMode ? '/profile/emergency-contacts/' + contactId : '{{ route('profile.emergency-contacts.store') }}'" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="tel" name="phone" x-model="contactPhone" oninput="this.value = this.value.replace(/[^0-9+\-\s()]/g, '');" required class="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-sm text-slate-100 focus:outline-none focus:border-indigo-500 transition">
                </div>
