...
@section('page_title', 'Edit Location: ' . $location->location_name)
        ...
        <form action="{{ route('locations.update', $location->id) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="location_code" id="location_code" required value="{{ old('location_code', $location->location_code) }}"
                ...
                <div>
                    ...
                    <input type="text" name="location_name" id="location_name" required value="{{ old('location_name', $location->location_name) }}"
                        class="w-full bg-slate-900/60 border border-white/10 rounded-2xl py-3 px-4 text-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition duration-200 text-sm" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="timezone" id="timezone" required
                        ...
                        <option value="Asia/Singapore" {{ old('timezone', $location->timezone) == 'Asia/Singapore' ? 'selected' : '' }}>Asia/Singapore (SGT)</option>
